# quaestor-ledger organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`quaestor-ledger`](https://github.com/quaestor-ledger).

## Canonical organization links

- GitHub organization: https://github.com/quaestor-ledger
- Public organization defaults: https://github.com/quaestor-ledger/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomquaestor-ledger-a8cd440b3acc
...
`quaestor-ledger` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
