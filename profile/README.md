...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`quaestor-ledger`](https://github.com/quaestor-ledger) GitHub owner.

Planning and delivery context is tracked in [github.com/quaestor-ledger](https://linear.app/denman/project/githubcomquaestor-ledger-a8cd440b3acc). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/quaestor-ledger/.github).
